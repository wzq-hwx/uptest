...
get_filename_component(_filename "/home/roc/tutorial_ws/src/ROS-Academy-for-Beginners/service_demo/srv/Greeting.srv" NAME_WE)
add_custom_target(_service_demo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "service_demo" "/home/roc/tutorial_ws/src/ROS-Academy-for-Beginners/service_demo/srv/Greeting.srv" ""
)
...
_generate_srv_cpp(service_demo
  "/home/roc/tutorial_ws/src/ROS-Academy-for-Beginners/service_demo/srv/Greeting.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service_demo)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/service_demo\")")
  # install generated code
  install(
